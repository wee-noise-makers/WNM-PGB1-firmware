...
package ASFML_Sim is
   ...
   Layout_Maps : constant
     ...
     (Qwerty_Layout => (C1             => sfKeyW,
                        ...
                        L7             => sfKeyK,
                        L8             => sfKeyL,
                        Lead_Alt       => sfKeyRShift,
                        Lead_Select    => sfKeyEnter,
                        Menu           => sfKeyNum9,
                        Func           => sfKeyEqual,
                        Chord_Alt      => sfKeyA,
                        Chord_Select   => sfKeyQ,
                        Drums_Play     => sfKeyDash,
                        Drum_Edit      => sfKeyNum0,
                        PAD_Up         => sfKeyUp,
                        PAD_Down       => sfKeyDown,
                        PAD_Left       => sfKeyLeft,
