...
\begin{tabularx}{\linewidth}{ m{0.24\textwidth} X }
  ...
  Welcome to the \device Quick Start Guide. This guide will help you get up and
  running quickly. You can refer to the full user manual online for
  comprehensive guidance and additional details: \newline \url{\usermanualurl}
...
\begin{tabularx}{\linewidth}{ m{0.24\textwidth} X }
  ...
  Join the \WNM discord server to engage with a community of users, share your
  experience, tips and tricks, and music made on the \device: \newline
  \url{\discordurl}

  And don't hesitate to tag us in your social media posts (@weenoisemakers), we
  will be happy to share your creations.
...
For example the following sequence will copy step 2 from pattern 5 of track 7, to step 9 from pattern 3 of track 1.
...
\begin{itemize}
    ...
    \item[] Piano Keyboard \dotfill Hold \kbd{Edit}
\end{itemize}
