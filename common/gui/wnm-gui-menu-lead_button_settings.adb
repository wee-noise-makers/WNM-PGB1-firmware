...
package body WNM.GUI.Menu.Lead_Button_Settings is
   ...
   begin
      ...
      Draw_Menu_Box ("Lead Note",
                     Count => Top_Settings_Count,
                     Index => Top_Settings'Pos (Top));
      case Top is
         when Key =>
            Draw_Value (Key_Img (Project.Note (Project.Editing_Lead)),
                        Selected => True);
      end case;
   ...
   begin
      case Event.Kind is
         ...
         when Up_Press =>
            Project.Next_Value (This.Current_Setting, Project.Editing_Lead);

         when Down_Press =>
            Project.Prev_Value (This.Current_Setting, Project.Editing_Lead);
